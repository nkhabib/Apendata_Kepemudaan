...
if ($jab == "kadus") 
{
 ...
 $pdf = new FPDF('p','mm','A4'); //l artinya landscape, p artinya potrait, A5 adalah ukuran kertas
        ...
        $pdf->Cell(190,6,'SURAT KETERANGAN TIDAK MAMPU',0,1,'C');
        ...
        $pdf->Cell(10,2,'',0,1);
        $pdf->MultiCell(190,6,'Orang tersebut diatas benar-benar warga kami yang berasal dari keluarga kurang mampu dan berpenghasilan tidak tetap, dan bermaksud untuk :',0,1);

        $pdf->Cell(10,6,'',0,0);
        $pdf->Cell(42,6,'Keperluan',0,0);
        $pdf->Cell(2,6,': ',0,0);
        $pdf->MultiCell(136,6,$perlu,0,1);
