          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel RT / RW</small></h2>
                    <div class="col-md-4">
                      <a href="<?php echo base_url('rtrw/rtrw/get_rtrw'); ?>" class="btn btn-info" >Kembali</a>
                    </div>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-md-offset-5">
                      <a href="<?= base_url('rtrw/rtrw/get_rtrw'); ?>">
